...
상단 **F2L 페어링**을 선택하고 1번부터 연습해 보세요. 초보 층별 풀이와 십자가 만들기·조각 꺼내기·분리는 건너뜁니다. 번호를 누르면 바로 아래에 풀이가 펼쳐집니다. 옆의 ⇄ 버튼으로 RG/RB 대칭을 전환하고, 수순 문자를 누르거나 이전/다음으로 회전을 앞뒤로 확인하세요. 풀이 숨김으로 직접 연습할 수 있습니다. 시작 조건과 학습 범위는 [SPEC](SPEC.md#f2l-페어링-훈련--확정)을 따릅니다.
