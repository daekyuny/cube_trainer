...
- F2L 페어링: R/G/W 코너는 앞·오른쪽 위, R/G 엣지는 O면 뒤·위에 고정한 5가지 유형. W 방향·윗색에 따른 최소 페어링 수순, 시연·직접 연습·상태 판정. Y층 페어까지만 연습하며 슬롯 삽입은 후속 단계입니다. 큐브 위에는 면 기호를 표시하지 않습니다.
...
상단 **F2L 페어링**을 선택하고 1번부터 연습해 보세요. 초보 층별 풀이와 십자가 만들기·조각 꺼내기·분리는 건너뜁니다. 각 유형에서 설명 보며 연습 또는 혼자 연습을 선택할 수 있습니다. 시작 조건과 학습 범위는 [SPEC](SPEC.md#f2l-페어링-훈련--확정)을 따릅니다.
